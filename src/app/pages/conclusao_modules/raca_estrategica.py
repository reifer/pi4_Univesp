...
def render():
    ...
    <div class="clean-card">
        <h3 style="margin-top: 0; color: #0F172A;">⚖️ 3. A Intersecção Estrutural: Renda Familiar x Raça/Cor e Desempenho</h3>
    </div>
    ...
    if ano_f3_raca == "Plurianual (2021-2025)":
        st.markdown("""
        <div class="clean-card">
            <strong>📊 Visão Plurianual da Intersecção Renda x Raça (2021–2025):</strong>
    ...
    with col_critica_f3_raca:
        ...
        <div class="clean-card" style="border-left: 4px solid #EF4444; height: 100%;">
            <h4 style="margin-top: 0; color: #991B1B;">🔍 Análise Crítica da Intersecção Étnico-Racial</h4>
