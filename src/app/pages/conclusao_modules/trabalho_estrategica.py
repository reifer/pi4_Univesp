...
def render():
    ...
    <div class="clean-card">
        <h3 style="margin-top: 0; color: #0F172A;">🛠️ 4. A Infraestrutura e o Trabalho: O Peso da Jornada e do Apoio Escolar</h3>
    </div>
    ...
    if ano_f4 == "Plurianual (2021-2025)":
        st.markdown("""
        <div class="clean-card">
            <strong>📊 Visão Plurianual de Infraestrutura e Condições de Trabalho (2021–2025):</strong>
    ...
    with col_critica_f4:
        ...
        <div class="clean-card" style="border-left: 4px solid #EF4444; height: 100%;">
            <h4 style="margin-top: 0; color: #991B1B;">🔍 Análise Crítica do Eixo de Trabalho e Infraestrutura</h4>
