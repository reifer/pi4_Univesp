...
- [x] **Filtros Globais:** Barra lateral interativa com multiselect de UFs, tipos de candidatos (Treineiro vs. Não Treineiro) e notas de negócio explicativas.
...
- [x] **Consumo de Dados Enriquecidos (_DESC):** Atualizar `src/app/dashboard.py` para carregar `enem_2025_enriched_parquet` e `enem_2025_dict.json`, exibindo rótulos legíveis nos componentes visuais.
